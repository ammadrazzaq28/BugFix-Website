...
| `terafort-single-file.html` | Quick share, email, or dropping into a preview tool. Everything inlined. |
...
**4. Contact** — `hello@terafort.com` appears in `index.html` and `assets/app.js`.
...
**5. Legal links** — already pointed at `terafort.com/T&C.html` and `/privacy.html`.
